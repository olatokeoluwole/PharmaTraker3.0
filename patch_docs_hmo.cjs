...
const oldCode = `const totalStock: number = Object.values(drug.branchStock || {}).reduce((a: number, b: any) => a + (Number(b) || 0), 0) as number;`;
const newCode = `const totalStock: number = Object.entries(drug.branchStock || {})
